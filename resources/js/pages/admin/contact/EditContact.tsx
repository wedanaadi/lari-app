...
import { useUpdateContact } from "@/features/contact";
...
export default function EditContact() {
  ...
  useEffect(() => {
    setValue("nama_contact", dataEdit.nama_contact);
    setValue("no_whatapp", dataEdit.no_whatapp);
  }, [dataEdit, setValue]);

  const { mutate: updateContact, isSuccess: contactIsSuccess } = useUpdateContact({
    onSuccess: () => {
      ToastNotification({
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="sm:text-2xl font-semibold">Edit Contact</h1>
