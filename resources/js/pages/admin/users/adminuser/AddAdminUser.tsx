...
export default function AddAdminUser() {
  ...
  const { mutate: createAdminUser } = useCreateUser({
    onSuccess: () => {
      ToastNotification({
        message: "User Admin created Successfuly",
        type: "success",
      });
      setTimeout(() => {
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="sm:text-2xl font-semibold">Add Admin</h1>
