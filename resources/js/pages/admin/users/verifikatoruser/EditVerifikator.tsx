...
export default function EditVerifikator() {
  ...
  const { mutate: updateVerifikatorUser } = useUpdateUser({
    onSuccess: () => {
      ToastNotification({
        message: "User verifikator updated Successfuly",
        type: "success",
      });
      setTimeout(() => {
  ...
  const saveData = (data: TEditUserScheme) => {
    ...
    updateVerifikatorUser(dataBody)
  }
  return (
    <div
      className={clsx(
    ...
    >
      ...
      >
        <h1 className="sm:text-2xl font-semibold">Edit Verifikator</h1>
