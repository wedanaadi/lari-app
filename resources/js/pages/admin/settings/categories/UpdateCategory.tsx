...
import { useUpdateCategories } from "@/features/sistem";
...
export default function UpdateCategory() {
  ...
  const { mutate: updateCategory, isSuccess:categoriesIsSuccess } = useUpdateCategories({
    onSuccess: () => {
      ToastNotification({
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="sm:text-2xl font-semibold">Edit Category Landing</h1>
        <Link
                ...
                render={({ field }) => (
                  <NumericFormat
                    ...
                    onValueChange={(target) => {
                      ...
                      target.floatValue !== undefined &&
                        setValue("price", target.floatValue);
                    }}
                    decimalScale={0}
