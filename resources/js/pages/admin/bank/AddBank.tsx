...
import { useCreateBank } from "@/features/bank";
...
export default function AddBank() {
  ...
  const { mutate: createContact, isSuccess:bankIsSuccess } = useCreateBank({
    onSuccess: () => {
      ToastNotification({
  ...
  return (
    ...
    >
      ...
      >
        <h1 className="sm:text-2xl font-semibold">Add Bank</h1>
